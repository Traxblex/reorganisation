...
// Définir des créneaux de yoga (exemples)
$sessions = [
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if (empty($errors)) {
		try {
			...
			$create = "CREATE TABLE IF NOT EXISTS inscriptions_yoga (
			...
			$stmt = $bddPDO->prepare('INSERT INTO inscriptions_yoga (prenom, nom, email, session_id, session_label) VALUES (:prenom, :nom, :email, :session_id, :session_label)');
			$stmt->execute([
				':prenom' => $prenom,
				':nom' => $nom,
				':email' => $email,
...
<title>Fitsport - Yoga</title>
<main class="container mt-5 pt-5">
	<div class="row">
		<div class="col-md-8">
			<h1 class="mb-4">Séances de YOGA</h1>
				...
				<?php foreach ($sessions as $s): ?>
					<div class="list-group-item d-flex justify-content-between align-items-center">
						<div>
							...
							<div class="text-muted">Durée: 1h — Coach: Amélia</div>
						</div>
