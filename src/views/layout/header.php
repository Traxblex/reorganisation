...
<head>
    ...
    <link rel="shortcut icon" href="../../assets/img/logo_fitsport.png" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="../../../index.php">
            <img src="../../assets/img/logo_fitsport.png" alt="Logo" width="30" height="24"
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav w-100"> <!-- Utilisation de w-100 pour étendre la barre de navigation sur toute la largeur -->
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../communication/contact.php">CONTACT</a>
                </li>
                <li class="nav-item">
