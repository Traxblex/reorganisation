...
<title>Fitsport - Inscription</title>
<link href="../frontend/login/css/styles.css" rel="stylesheet">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirmer le mot de passe" />
                                    <label for="inputPasswordConfirm">Confirme ton mot de passe</label>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4 mb-0">
                            <div class="d-grid">
                                <a class="btn btn-primary btn-block" href="index.php?controller=auth&action=login">
                                    Créer un compte
                                </a>
                            </div>
                        </div>
